...
def main(args):
    ...
    neps_root_directory = get_neps_root_directory(args.n_params, "time_sequence", args.searcher, args.seed)
    ...
    if not args.plot_only:
        ...
        if ifbo_alternative:
            neps_kwargs["surrogate_model_args"] = {
                ...
                "max_value": 1.0,  # empirical value from epoch 0 after a few runs
            }
